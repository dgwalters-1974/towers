...
w2v.load_state_dict(
    torch.load(
        '/Users/dgwalters/ML Projects/MLX-2/two-towers-final/state-dics/2025_02_09__11_27_23.1.70000.w2v.pth',
        map_location=dev  # This ensures the model loads on the correct device
    )
)
